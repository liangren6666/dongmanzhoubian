...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const src = common_vendor.computed(() => buildSvg(props.name, props.color));
    return (_ctx, _cache) => {
      return {
        a: src.value,
        b: __props.size + "rpx",
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-2977a9e6"]]);
